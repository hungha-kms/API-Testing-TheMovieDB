...
response1 = TVEpisodes.getImages(TVID, seasonNo, episodeNo)

String tittleStr = 'TV Episodes/Get Images for TVID: '+ TVID + "; season Number: " + seasonNo + "; Episode Number: " +episodeNo
