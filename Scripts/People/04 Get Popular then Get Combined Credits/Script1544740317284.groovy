...
response1 = People.getCombinedCredits(personID)
TheMovieDBCommon.printDataValue(response1, 'People/Get Combined Credits')
...
if (response1 != null) {
    ...
    if (resultSize >= 0) {
		...
		String creditID = dataValue.cast[i].credit_id
