...
RequestObject reqObj = findTestObject('Account/Make As Favorite')
...
String body = toJson(media_type: 'tv', media_id: 4629, favorite: true)
reqObj.setBodyContent(new HttpTextBodyContent(body))

ResponseObject response1 = WS.sendRequest(reqObj)

common.printDataValue(response1, 'Account/Make As Favorite')
