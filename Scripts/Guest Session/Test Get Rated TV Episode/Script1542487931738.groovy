...
TheMovieDBCommon.printDataValue(resp, 'TV Episodes/Rate TV Episode')

reqObj = findTestObject('GuestSession/Get Rated TV Episodes')

String urlStr = 'https://api.themoviedb.org/3/guest_session/' + guestSessionID

urlStr += ('/rated/tv/episodes?api_key=' + GlobalVariable.apiKey)

reqObj.setRestUrl(urlStr)

resp = WS.sendRequest(reqObj)

TheMovieDBCommon.printDataValue(resp, 'GuestSession/Get Rated TV Episodes')