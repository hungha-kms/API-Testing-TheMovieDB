...
response1 = WS.sendRequest(findTestObject('Authentication/Create Session With Login'))

dataValue = slurper.parseText(response1.getResponseBodyContent())

println ("*************** Create session with login result: "+ dataValue)
