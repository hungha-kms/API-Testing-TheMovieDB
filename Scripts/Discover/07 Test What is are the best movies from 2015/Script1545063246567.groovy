...
params.add(new TestObjectProperty('primary_release_year', ConditionType.EQUALS, "2015"))
...
WS.verifyElementPropertyValue(resObj, 'results[5].title', 'The Corrs: BBC Radio 2 Live at Hyde Park')

TheMovieDBCommon.printDataValue(resObj, "What is are the best movies from 2015")
