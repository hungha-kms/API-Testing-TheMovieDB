...
TheMovieDBCommon.printDataValue(resObj, "What are the best drama's")

WS.verifyElementPropertyValue(resObj, 'results[8].title', 'Once Upon a Time the City of Fools')