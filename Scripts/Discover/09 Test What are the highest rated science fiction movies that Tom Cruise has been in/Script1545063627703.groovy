...
params.add(new TestObjectProperty('with_genres', ConditionType.EQUALS, "878"))
params.add(new TestObjectProperty('with_cast', ConditionType.EQUALS, "500"))
...
WS.verifyElementPropertyValue(resObj, 'results[2].title', 'Minority Report')
