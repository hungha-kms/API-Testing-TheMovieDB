...
public class Credits {
	public static ResponseObject getDetails(String id){
		RequestObject reqObj = findTestObject('Credits/Get Details')
		String urlStr = 'https://api.themoviedb.org/3/credit/' + id
